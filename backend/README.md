...
## Project Structure
    ...
    ├── testapiautosetting_124860  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_124860`
...
2. Clone this repo and `cd testapiautosetting_124860`
